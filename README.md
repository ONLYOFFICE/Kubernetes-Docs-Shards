...
| `customBalancer.startupProbe.httpGet.path`                  | Checking the path for startupProbe                                                                                                                                             | `/healthcheck`                                                                            |
...
| `customBalancer.readinessProbe.httpGet.path`                | Checking the path for readinessProbe                                                                                                                                           | `/healthcheck`                                                                            |
...
| `customBalancer.livenessProbe.httpGet.path`                 | Checking the path for livenessProbe                                                                                                                                            | `/healthcheck`                                                                            |
...
| `customBalancer.image.tag`                                  | Specify balancer image tag                                                                                                                                                     | `8.2.0-1`                                                                                   |
