...
| `serviceAccount.name`                                       | Name of the ServiceAccount to be used. If not set and `serviceAccount.create` is `true` the name will be taken from `.Release.Name` or `serviceAccount.create` is `false` the name will be "default" | `ds-docs-sa`                                                        |
...
| `persistence.annotations`                                   | Defines annotations that will be additionally added to "ds-service-files" PVC. If set to, it takes priority over the `commonAnnotations`                                       | `{}`                                                                                      |
...
| `documentserver.annotations`                                | Defines annotations that will be additionally added to Documentserver Deployment. Annotations required by prometheus for collecting metrics can also be added here.            | `{}`                                                                                      |
...
| `documentserver.initContainers.image.tag`                   | Documentserver add-shardkey initContainer image tag                                                                                                                            | `9.1.0-1`                                                                                 |
...
| `documentserver.docservice.image.tag`                       | Docservice container image tag                                                                                                                                                 | `9.1.0-1`                                                                                 |
...
| `documentserver.proxy.image.tag`                            | Docservice Proxy container image tag                                                                                                                                           | `9.1.0-1`                                                                                 |
...
| `documentserver.converter.image.tag`                        | Converter container image tag                                                                                                                                                  | `9.1.0-1`                                                                                 |
...
| `documentserver.postgresql.metrics.enabled`                 | Defines enabled or disabled sidecar container with psql metrics prometheus exporter                                                                                            | `false`                                                                                   |
| `documentserver.postgresql.metrics.pullPolicy`              | Postgresql prometheus metrics exporter container image pull policy                                                                                                             | `IfNotPresent`                                                                            |
| `documentserver.postgresql.metrics.containerSecurityContext.enabled`| Enable security context for the Postgresql container                                                                                                                   | 'false'                                                                                   |
| `documentserver.postgresql.metrics.containerSecurityContext.runAsUser` | User ID for the Postgresql container                                                                                                                                | `0`                                                                                       |
| `documentserver.postgresql.metrics.containerSecurityContext.runAsGroup` | Group ID for the Postgresql container                                                                                                                              | `0`                                                                                       |
| `documentserver.postgresql.metrics.containerSecurityContext.allowPrivilegeEscalation` | Controls whether a process can gain more privileges than its parent process                                                                          | `false`                                                                                   |
| `documentserver.postgresql.metrics.containerSecurityContext.seccompProfile` |  Defines the Seccomp profile for the Postgresql container                                                                                                      | `RuntimeDefault`                                                                          |
| `documentserver.postgresql.metrics.containerSecurityContext.capabilities` | Defines the privileges granted to the process                                                                                                                    | `[ALL]`                                                                                   |
| `documentserver.postgresql.metrics.resources.requests.memory` | The memory requests for the psql metric exporter container                                                                                                                   | `256Mi`                                                                                   |
| `documentserver.postgresql.metrics.resources.requests.cpu`  | The cpu requests for the psql metric exporter container                                                                                                                        | `200m`                                                                                    |
| `documentserver.postgresql.metrics.resources.limits.memory` | The memory requests for the psql metric exporter container                                                                                                                     | `1Gi`                                                                                     |
| `documentserver.postgresql.metrics.resources.limits.cpu`  | The cpu requests for the psql metric exporter container                                                                                                                          | `1000m`                                                                                   |
...
| `documentserver.rabbitmq.metrics.enabled`                   | Disable or enable metrics for rabbitmq image                                                                                                                                   | `false`                                                                                   |
...
| `adminpanel.image.tag`                                      | Admin panel container image tag                                                                                                                                                  | `9.1.0-1`                                                                               |
...
| `example.image.tag`                                         | Example container image tag                                                                                                                                                    | `9.1.0-1`                                                                                 |
...
| `customBalancer.hostAliases`                                | Adds [additional entries](https://kubernetes.io/docs/tasks/network/customize-hosts-file-for-pods/) to the hosts file in the Balancer container                                     | `[]`                                                                                  |
...
| `customBalancer.image.tag`                                  | Specify balancer image tag                                                                                                                                                     | `9.1.0-1`                                                                                   |
...
| `upgrade.job.image.tag`                                     | Job by pre-upgrade image tag                                                                                                                                                   | `9.1.0-1`                                                                                 |
...
| `delete.job.image.tag`                                      | Job by pre-delete image tag                                                                                                                                                    | `9.1.0-1`                                                                                 |
...
| `grafanaDashboard.job.image.tag`                            | Job by Grafana Dashboard ONLYOFFICE Docs image tag                                                                                                                      | `9.1.0-1`                                                                                 |
...
| `wopiKeysGeneration.job.image.tag`                          | Job by Wopi Keys Generation ONLYOFFICE Docs image tag                                                                                                                          | `9.1.0-1`                                                                                 |
...
| `wopiKeysDeletion.job.image.tag`                            | Job by Wopi Keys Deletion ONLYOFFICE Docs image tag                                                                                                                            | `9.1.0-1`                                                                                 |
...
| `tests.image.tag`                                           | Test container image tag                                                                                                                                                       | `9.1.0-1`                                                                                 |
