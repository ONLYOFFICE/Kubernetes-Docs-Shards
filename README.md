...
| `documentserver.initContainers.image.tag`                   | Documentserver add-shardkey initContainer image tag                                                                                                                            | `8.3.0-1`                                                                                 |
...
| `documentserver.docservice.image.tag`                       | Docservice container image tag                                                                                                                                                 | `8.3.0-1`                                                                                 |
...
| `documentserver.proxy.image.tag`                            | Docservice Proxy container image tag                                                                                                                                           | `8.3.0-1`                                                                                 |
...
| `documentserver.converter.image.tag`                        | Converter container image tag                                                                                                                                                  | `8.3.0-1`                                                                                 |
...
| `example.image.tag`                                         | Example container image tag                                                                                                                                                    | `8.3.0-1`                                                                                 |
...
| `customBalancer.image.tag`                                  | Specify balancer image tag                                                                                                                                                     | `8.3.0-1`                                                                                   |
...
| `upgrade.job.image.tag`                                     | Job by pre-upgrade image tag                                                                                                                                                   | `8.3.0-1`                                                                                 |
...
| `delete.job.image.tag`                                      | Job by pre-delete image tag                                                                                                                                                    | `8.3.0-1`                                                                                 |
...
| `grafanaDashboard.job.image.tag`                            | Job by Grafana Dashboard ONLYOFFICE Docs image tag                                                                                                                      | `8.3.0-1`                                                                                 |
...
| `wopiKeysGeneration.job.image.tag`                          | Job by Wopi Keys Generation ONLYOFFICE Docs image tag                                                                                                                          | `8.3.0-1`                                                                                 |
...
| `wopiKeysDeletion.job.image.tag`                            | Job by Wopi Keys Deletion ONLYOFFICE Docs image tag                                                                                                                            | `8.3.0-1`                                                                                 |
...
| `tests.image.tag`                                           | Test container image tag                                                                                                                                                       | `8.3.0-1`                                                                                 |
