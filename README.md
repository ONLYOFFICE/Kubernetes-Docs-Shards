...
| `documentserver.initContainers.image.tag`                   | Documentserver add-shardkey initContainer image tag                                                                                                                            | `8.2.2-1`                                                                                 |
...
| `documentserver.docservice.image.tag`                       | Docservice container image tag                                                                                                                                                 | `8.2.2-1`                                                                                 |
...
| `documentserver.proxy.image.tag`                            | Docservice Proxy container image tag                                                                                                                                           | `8.2.2-1`                                                                                 |
...
| `documentserver.converter.image.tag`                        | Converter container image tag                                                                                                                                                  | `8.2.2-1`                                                                                 |
...
| `example.image.tag`                                         | Example container image tag                                                                                                                                                    | `8.2.2-1`                                                                                 |
...
| `customBalancer.image.tag`                                  | Specify balancer image tag                                                                                                                                                     | `8.2.2-1`                                                                                   |
...
| `upgrade.job.image.tag`                                     | Job by pre-upgrade image tag                                                                                                                                                   | `8.2.2-1`                                                                                 |
...
| `grafanaDashboard.job.image.tag`                            | Job by Grafana Dashboard ONLYOFFICE Docs image tag                                                                                                                      | `8.2.2-1`                                                                                 |
